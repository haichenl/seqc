...
%                 disp([mu,nu,bondParameter]);
        ...
        function res = AtomGetOrbitalExponent(~, atom, shellType, orbitalType)
            ...
            elseif(shellType == 3 && (orbitalType == 1  || ...
                ...
                res = atom.paramPool.zindo_effectiveNuclearChargeMsp/atom.GetEffectivePrincipalQuantumNumber(shellType);
            elseif(shellType == 3 && (orbitalType == 5  || ...
                    orbitalType == 6 ||...
                    orbitalType == 7 ||...
                    orbitalType == 8 ||...
                    orbitalType == 9)) % mShell, dxy dyz dzz dzx dxxyy
                res = atom.paramPool.zindo_effectiveNuclearChargeMd/atom.GetEffectivePrincipalQuantumNumber(shellType);
            elseif(shellType == 4 && (1  || ...
                ...
                throw(MException('ZindoS:AtomGetOrbitalExponent', 'Shell/Orbital type wrong.'));
            end
        end
